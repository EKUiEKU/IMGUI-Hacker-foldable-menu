...
namespace ImGui
{
    ...
    IMGUI_API void          _SecondItem(const char* title, const char* status ,const int color, const int bg_color,ImVec2 size,bool open, bool selected);
    IMGUI_API void          _FirstItem(const char* title, const char* status, const int color, const int bg_color,  ImVec2 size, bool selected);
    IMGUI_API void          _Title(const char* title, const int color, const int bg_color, ImVec2 size);

    //对上面的控件进行封装

    IMGUI_API void          SecondItem(const char* title, const char* status, bool open, bool selected);
    IMGUI_API void          FirstItem(const char* title, const char* status, bool selected);
    IMGUI_API void          Title(const char* title);
